...
class JeolCom
{
	...
	static short EOS3GetProbeMode(short* mode, string* name);
	...
	static short EOS3GetFunctionMode(short* mode, string* name);
	static short EOS3SetSelector(short sel);
	static short EOS3UpSelector();
	static short EOS3DownSelector();
	static short EOS3GetMagValue(long* mag, string* unit, string* string);
	...
	static short EOS3GetSpctrValue(long* dispersion, string* unit, string* string);
	static short EOS3SetStemCamSelector(short sel);
	static short EOS3UpStemCamSelector();
	static short EOS3DownStemCamSelector();
	static short EOS3GetStemCamValue(long* cam, string* unit, string* string);
	...
	static short EFILTER3SetSlitPosition(short inout);
